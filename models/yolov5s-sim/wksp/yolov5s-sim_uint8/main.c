...
{
    vnn_ReleaseYolov5sSimUint8( graph, TRUE );
...
{
    return vnn_PostProcessYolov5sSimUint8( graph );
}
    ...
    )
{
    ...
    return vnn_PreProcessYolov5sSimUint8( graph, inputs, input_num );
}
    ...
    )
{
    ...
    tmsStart = get_perf_count();
    graph = vnn_CreateYolov5sSimUint8( data_file_name, NULL,
