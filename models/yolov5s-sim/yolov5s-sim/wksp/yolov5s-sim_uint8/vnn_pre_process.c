...
static void _load_input_meta()
{
    ...
    input_meta_tab[0].image.scale[0] = 0.00392157;
    input_meta_tab[0].image.scale[1] = 0.00392157;
    input_meta_tab[0].image.scale[2] = 0.00392157;
...
vsi_status vnn_PreProcessYolov5sSimUint8
    (
    vsi_nn_graph_t *graph,
    const char **inputs,
    uint32_t input_num
