...
If defaults fail, startup tries a fallback candidate list and also scans `/sys/class/pwm/*/npwm` to probe available chips/channels, then logs the selected mapping.
