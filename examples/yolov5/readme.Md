...
Servo range conventions are aligned with ArduinoCatLaserpointer:

- pan/side axis: `60..120` deg, neutral `90`
- tilt/front axis: `40..100` deg, neutral `70`

The Linux runtime uses these bounds when converting logical offsets to PWM pulse widths.
